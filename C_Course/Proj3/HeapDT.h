...
/// createHeap constructs an empty heap with a given, fixed capacity.
/// @param capacity the maximum number of elements to be inserted
/// @param compFun function determines the ordering of the heap
/// by the values of the heap payload. A <= operation will produce
/// a 'minheap', and a >= operation will produce a 'maxheap'.
/// @param dumpEntry function that knows how to print/display 
/// each single payload element in the heap, largely for debugging.
...
/// involved dynamic memory allocation. Otherwise memory leaks.
