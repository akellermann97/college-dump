...
//
//	$Log: Matrix.h,v $
//	Revision 1.1  2016/10/27 16:49:54  csci243
//	Initial revision
//
...
///
void matInit( Matrix mat, const float data[] );
...
///
Matrix matDuplicate( const Matrix mat );
...
///
bool matEquals( const Matrix m1, const Matrix m2 );
...
///
void matScalarMult( Matrix mat, float data );
...
///
Status matGetCell( const Matrix mat, float *data, size_t row, size_t col );
...
// @return a status code indicating the result of the operation
///
Status matGetRow( const Matrix mat, float data[], size_t row );
...
// @return a status code indicating the result of the operation
///
Status matSetCell( Matrix mat, float data, size_t row, size_t col );
...
// @return a status code indicating the result of the operation
///
Status matSetRow( Matrix mat, const float data[], size_t row );
...
///
void matPrint( const Matrix mat, FILE *stream );
